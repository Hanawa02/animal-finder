...
public class AnimalFinderModItems {
    ...
    public static final RegistryObject<Item> COPPER_ANIMAL_FINDER = ITEMS.register("copper_animal_finder", () -> new AnimalFinderToolItem(new Item.Properties(), 64, 2));
    public static final RegistryObject<Item> IRON_ANIMAL_FINDER = ITEMS.register("iron_animal_finder", () -> new AnimalFinderToolItem(new Item.Properties(), 96, 4));
